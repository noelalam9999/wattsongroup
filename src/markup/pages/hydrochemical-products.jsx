...
// Elements
import Masonry from "../elements/portfolio/hydrochemical-products";
import ProjectSlider1 from '../elements/project-slider/project-slider-1';

// Images
import Banner1 from "../../images/banner/banner1.jpg"

class ProjectGrid4 extends Component {
					...
					<div className="page-banner ovbl-dark parallax" style={{backgroundImage: "url("+Banner1+")"}}>
						<div className="container">
							<div className="page-banner-entry">
								<h1 className="text-white">Hydrochemical Bangladesh Products</h1>
								<div className="breadcrumb-row">
									<ul className="list-inline">
										<li><Link to="/"><i className="fa fa-home"></i> Home</Link></li>
										<li>Hydrochemical Bangladesh Products</li>
									</ul>
								</div>
							 </div>
						</div>
