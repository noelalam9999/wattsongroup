...
import Portfolio from '../elements/portfolio/air-conditioning-concerns';
// Elements
import About from '../elements/about/airconditioning';
import Testimonial2 from '../elements/testimonial/testimonial2';
import Services from '../elements/services/services';
import Action from '../elements/action/airconditioning';
import Count from '../elements/counter/counter-sensor';
import { Link } from 'react-router-dom';
// Images
import Banner2 from "../../images/banner/HVAC-System-Work-CoyneCollege-Chicago-1536x1024.jpeg"
					...
					<div className="page-banner ovbl-dark page-banner-lg ovdt1 overlay-dotted no-pt parallax" style={{backgroundImage: "url("+Banner2+")"}}>
						<div className="container">
							<div className="page-banner-entry">
								<span className="banner-sm-title"></span>
								<h1 className="text-white">Air conditioning </h1>
							 </div>
						</div>
					</div>
						...
						<div className="section-area section-sp2">
							<div className="container">
								<div className="heading-bx text-center">
									...
									<h2 className="title-head m-b0">Our Promise</h2>
								...
								<div className="row">
									<div className="col-md-4 m-sm-b40">
										<div className="feature-container center feature-bx3 right-img">
											...
											<div className="icon-content">
												<h4 className="ttr-tilte"></h4>
												<p>We promise to provide excellency in our services to ensure clients' satisfaction.</p>
											</div>
									...
									<div className="col-md-4 m-sm-b40">
										<div className="feature-container center feature-bx3 right-img2">
											...
											<div className="icon-content">
												<h4 className="ttr-tilte"></h4>
												<p>We only provide the best quality products with better quality of after sales service.</p>
											</div>
											<i className="ti-panel bg-icon"></i>
										</div>
									</div>
									<div className="col-md-4">
										<div className="feature-container center feature-bx3">
											...
											<div className="icon-content">
												<h4 className="ttr-tilte"></h4>
												<p>We are one of the most experienced in air-conditioning sector with business years of 20.</p>
											</div>
											<i className="ti-panel bg-icon"></i>
										</div>
									</div>
